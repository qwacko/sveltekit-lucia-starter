<script lang="ts">
	...
	const variantClasses = {
		...
		outline:
			'border-2 border-blue-300 dark:border-blue-600 bg-transparent text-blue-700 dark:text-blue-300 hover:bg-blue-50 dark:hover:bg-blue-950 hover:border-blue-400 dark:hover:border-blue-500',
		secondary:
			'bg-gradient-to-r from-gray-100 to-gray-200 dark:from-gray-700 dark:to-gray-800 text-gray-900 dark:text-gray-100 hover:from-gray-200 hover:to-gray-300 dark:hover:from-gray-600 dark:hover:to-gray-700 border border-gray-300 dark:border-gray-600',
		ghost:
			'hover:bg-blue-50 dark:hover:bg-blue-950 text-blue-700 dark:text-blue-300 hover:text-blue-800 dark:hover:text-blue-200',
