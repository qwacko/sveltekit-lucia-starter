...
<div class="flex-1 p-8">
	<div class="max-w-6xl mx-auto">
		...
		<div class="text-center mb-8">
			<h1
				class="text-3xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent mb-4"
			>
				WebSocket Demo
			</h1>
			<div
				class="bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm rounded-xl border border-gray-200 dark:border-gray-700 p-6 shadow-lg mb-6"
			>
				<p class="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
					Real-time mouse cursor sharing using WebSockets. Unlike Server-Sent Events, WebSockets
					provide bidirectional communication for instant updates.
				</p>

				<!-- Room Navigation -->
				<div class="flex flex-wrap justify-center gap-3 mb-4">
					<a
						class="bg-blue-100 hover:bg-blue-200 dark:bg-blue-900/30 dark:hover:bg-blue-800/40 text-blue-800 dark:text-blue-200 px-4 py-2 rounded-lg font-medium transition-colors"
						href="/ws/room1">Room 1</a
					>
					<a
						class="bg-blue-100 hover:bg-blue-200 dark:bg-blue-900/30 dark:hover:bg-blue-800/40 text-blue-800 dark:text-blue-200 px-4 py-2 rounded-lg font-medium transition-colors"
						href="/ws/room2">Room 2</a
					>
					<a
						class="bg-red-100 hover:bg-red-200 dark:bg-red-900/30 dark:hover:bg-red-800/40 text-red-800 dark:text-red-200 px-4 py-2 rounded-lg font-medium transition-colors"
						href="/ws/disallowedRoom3">Disallowed Room</a
					>
				</div>
			</div>
			...
			<div class="grid md:grid-cols-3 gap-4 mb-8">
				<div
					class="bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm rounded-lg border border-gray-200 dark:border-gray-700 p-4 shadow-sm"
				>
					<div class="flex items-center gap-3">
						<div
							class:dot-green={socketState.connected}
							class:dot-red={!socketState.connected}
						></div>
			...
			{#if socketState.socketError}
				<div
					class="bg-red-50 dark:bg-red-950/30 border border-red-200 dark:border-red-800 rounded-lg p-4 mb-6"
				>
		...
		{#if targetSocket && socketState.connected && socketState.userConnected && socketState.roomConnected}
			...
			<div class="text-center mb-8">
				<div
					class="inline-flex items-center gap-2 bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-200 px-4 py-2 rounded-lg font-medium"
				>
					<div class="w-2 h-2 bg-green-500 rounded-full animate-pulse"></div>
					Connected to Room:<code class="bg-green-200 dark:bg-green-800 px-2 py-1 rounded"
						>{data.id}</code
					>
				</div>
			</div>
			...
			<!-- Info Section -->
			<div
				class="bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-950/30 dark:to-pink-950/30 rounded-xl border border-purple-200 dark:border-purple-800 p-6"
			>
