...
<div class="flex-1 flex flex-col items-center justify-center p-8">
	<div class="max-w-4xl w-full text-center mb-12">
		...
		<p class="text-xl text-gray-600 dark:text-gray-300 mb-8 leading-relaxed">
			A modern, full-stack application with authentication, real-time features, and beautiful design.
		</p>
	</div>
	...
	{#if data.user}
		<div class="w-full max-w-2xl">
			<div class="bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm rounded-xl border border-gray-200 dark:border-gray-700 p-6 shadow-lg">
				...
				<pre class="text-sm text-gray-700 dark:text-gray-300 overflow-auto max-h-96 bg-gray-50 dark:bg-gray-900 rounded-lg p-4">{JSON.stringify(data, null, 2)}</pre>
			</div>
		</div>
	{:else}
		<div class="w-full max-w-md">
			<div class="bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm rounded-xl border border-gray-200 dark:border-gray-700 p-6 shadow-lg text-center">
